...
from tap_aftership.sync import write_schema, sync, update_currently_syncing
from tap_aftership.streams import Trackings, Couriers
...
class TestSync(unittest.TestCase):
    ...
    def test_write_schema_only_parent_selected(self):
        ...
        mock_stream.children = ["orders", "products"]
    ...
    def test_write_schema_parent_child_both_selected(self):
        ...
        write_schema(mock_stream, client, ["orders"], catalog)
    ...
    def test_write_schema_child_selected(self):
        ...
        write_schema(mock_stream, client, ["orders", "products"], catalog)
    ...
    @patch("tap_aftership.streams.abstracts.IncrementalStream.sync")
    def test_sync_stream1_called(self, mock_sync, mock_write_state, mock_transformer, mock_get_currently_syncing, mock_write_schema):
        ...
        tracking_stream = MagicMock()
        tracking_stream.stream = "trackings"
        courier_stream = MagicMock()
        courier_stream.stream = "courier_connections"
    ...
    def test_sync_child_selected(self, mock_sync, mock_write_state, mock_transformer, mock_get_currently_syncing, mock_write_schema):
        ...
        tracking_stream.stream = "trackings"
        courier_stream = MagicMock()
        courier_stream.stream = "couriers"
        mock_catalog.get_selected_streams.return_value = [
            tracking_stream,
            courier_stream
        ]
