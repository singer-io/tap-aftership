...
class TestClient(unittest.TestCase):
    ...
    @patch("tap_aftership.client.Client._Client__make_request")
    ...
    @parameterized.expand([
        ...
        ["429 error", 429, MockResponse(429), aftershipRateLimitError, "The API rate limit for your organisation/application pairing has been exceeded."],
