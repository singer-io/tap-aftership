...
class TestSync(unittest.TestCase):
    @patch("tap_aftership.streams.abstracts.metadata.to_map")
    ...
    @patch("tap_aftership.streams.abstracts.ParentBaseStream.is_selected", return_value=True)
    @patch("tap_aftership.streams.abstracts.ParentBaseStream.get_bookmark", return_value=100)
    ...
    @patch("tap_aftership.streams.abstracts.BaseStream.is_selected", return_value=False)
    @patch("tap_aftership.streams.abstracts.IncrementalStream.get_bookmark", return_value = 100)
    ...
    @patch("tap_aftership.streams.abstracts.BaseStream.is_selected", return_value=True)
    @patch("tap_aftership.streams.abstracts.IncrementalStream.get_bookmark", side_effect = [100, 50, 75])
    ...
    @patch("tap_aftership.streams.abstracts.BaseStream.is_selected", return_value=False)
    @patch("tap_aftership.streams.abstracts.IncrementalStream.get_bookmark", side_effect = [75, 50])
